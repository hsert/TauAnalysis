...
# with command line options: step3 --runUnscheduled --conditions 80X_mcRun2_asymptotic_2016_v3 --filein file:step2.root --fileout file:skimmed_to_reco.root --step RAW2DIGI,L1Reco,RECO,PAT --datatier MINIAODSIM --era Run2_25ns --eventcontent MINIAODSIM --customise TauAnalysis/EmbeddingProducer/customisers.customiseAllSteps --no_exec -n -1 --python_filename step3.py
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:skimmed_to_reco.root'),
