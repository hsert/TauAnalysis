...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:DoubleMuonData2015RAW.root'),
...
process.MINIAODoutput.outputCommands.extend(cms.untracked.vstring(
	...
	# LHE product and related collections for GEN step and subsequent vertex correction
...
process.skimming = cms.Path(process.makePatMuonsZmumuSelection+process.externalLHEProducer)
