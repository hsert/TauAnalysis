...
# with command line options: RECO -s L1Reco,RECO,PAT --runUnscheduled --data --scenario pp --conditions 76X_dataRun2_v15 --era Run2_25ns --eventcontent MINIAOD --datatier MINIAOD --customise TauAnalysis/EmbeddingProducer/customisers.customiseAllSteps --filein root://cache-cms-xrootd.desy.de:1094//store/data/Run2015D/DoubleMuon/RECO/16Dec2015-v1/10000/002C811B-80A7-E511-8C4D-0CC47A4D7644.root -n 20 --no_exec --python_filename=rerecoAndPAT.py --no_exec --fileout rerecoAndPAT.root
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('RECO nevts:20'),
...
process.MINIAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('rerecoAndPAT.root'),
