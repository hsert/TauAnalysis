...
# with command line options: step3 --runUnscheduled --conditions 76X_mcRun2_asymptotic_v12 --filein file:step2.root --fileout file:step3.root --step RAW2DIGI,L1Reco,RECO,EI,PAT --datatier GEN-SIM-RECO,MINIAODSIM --era Run2_25ns --eventcontent RECOSIM,MINIAODSIM --customise TauAnalysis/EmbeddingProducer/customisers.customiseAllSteps --no_exec --mc -n -1
...
process.CSCHaloData.HLTResultLabel = cms.InputTag("TriggerResults","","HLTembedding")
process.patTrigger.processName = cms.string('HLTembedding')
