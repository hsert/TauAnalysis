...
# with command line options: step2 --conditions auto:run2_mc_25ns14e33_v4 --filein file:step1.root --fileout file:step2.root --step DIGI:pdigi_valid,L1,DIGI2RAW,HLT:@relval25ns --datatier GEN-SIM-DIGI-RAW-HLTDEBUG --era Run2_25ns --eventcontent FEVTDEBUGHLT --customise TauAnalysis/EmbeddingProducer/customisers.customiseAllSteps --no_exec -n -1
