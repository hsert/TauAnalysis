...
template <typename T>
bool TrackerCleaner<T>::test_veto_rechit(const TrackingRecHit *murechit){
...
template <>
bool TrackerCleaner<SiStripCluster>::test_veto_rechit(const TrackingRecHit *murechit){
 ...
 template <>
bool TrackerCleaner<SiPixelCluster>::test_veto_rechit(const TrackingRecHit *murechit){
